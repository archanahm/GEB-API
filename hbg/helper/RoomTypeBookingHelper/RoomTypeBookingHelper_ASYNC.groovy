...
class RoomTypeBookingHelper_ASYNC extends RoomTypeBookingHelper{
...
/*    ExcelUtil excelUtil
    ...
    RoomTypeBookingHelper_ASYNC(String excelPath, String clientId){
    ...
    *//**
    ...
    <RequestDetails>
        ...
        <ItemDestination DestinationCode = "${dataMap.get('DestinationCode')}" DestinationType = "${dataMap.get('SEARCH_HOTEL.Destination_type')}"/>
            
            <PeriodOfStay>
                <CheckInDate>${getCheckInDate()}</CheckInDate>
                <Duration>${dataMap.get('SEARCH_HOTEL.Duration')}</Duration>
            </PeriodOfStay>
            <IncludeChargeConditions DateFormatResponse="${dataMap.get('Request_DateFormatResponse')}"/>
            <Rooms>
                <Room
                    Code = "${dataMap.get('HotelRoom_Code')}"
                    NumberOfCots = "${dataMap.get('SEARCH_HOTEL.Room_numberOfCots1')}"
...
<Request>
    ...
    <AddBookingRequest Currency = "${dataMap.get('REQUEST.Currency')}">
        ...
        <PaxNames>
            <PaxName PaxId = "${dataMap.get('PaxName.PaxId1')}">JESS TEST</PaxName>
            <PaxName PaxId = "${dataMap.get('PaxName.PaxId2')}">TETS 2</PaxName>
            <PaxName PaxId = "${dataMap.get('PaxName.PaxId3')}">JESS3 TEST</PaxName>
            <PaxName PaxId = "${dataMap.get('PaxName.PaxId4')}">TETS 3</PaxName>
            <PaxName PaxId = "${dataMap.get('PaxName.PaxId5')}">TETS 4</PaxName>
        </PaxNames>
   <BookingItems>
        ...
        <HotelItem>
            ...
            <HotelRooms>
                <HotelRoom
                    Code = "${dataMap.get('HotelRoom_Code')}"
                    ExtraBed = "${dataMap.get('HotelRoom.NumberOfExtraBeds')}"
                    Id = "${dataMap.get('HotelRoomId')}"
                    SharingBedding = "${dataMap.get('HotelRoom_SharingBedding')}"
                    NumberOfCots = "${dataMap.get('SEARCH_HOTEL.Room_numberOfCots1')}">
                    <PaxIds>
    ...
    public def searchBookingRequestAsync(String sheetName,int rowNum, def xmlName ) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
   ...
   <RequestDetails>
        <SearchBookingRequest>
            <BookingDateRange DateType = "${dataMap.get('BookingDateRange.DateType')}">
    ...
    public def searchBookingRequestBookingIDAsync(String sheetName,int rowNum, def bookingId,xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap && dataMap.get("Flag")){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
   ...
   <RequestDetails>
    ...
    public def AddBookingItemRequestSbAsync(String sheetName,int rowNum, def bookingId, def itemCity, def itemCode, def roomId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        dataMap.put('BookingItemCityCode', itemCity)
        dataMap.put('BookingItemCode', itemCode)
...
<Request>
   ...
   <RequestDetails>
    ...
    public def AddBookingItemRequestDB_GTA_ASYNC(String sheetName,int rowNum, def bookingId, def itemCity, def itemCode, def roomId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        dataMap.put('BookingItemCityCode', itemCity)
        dataMap.put('BookingItemCode', itemCode)
        dataMap.put('HotelRoomId', roomId)
...
<Request>
  <Source>
   ...
   <RequestDetails>
                    ...
                    <HotelItem>
                        ...
                        <HotelRooms>
                            <HotelRoom 
                                ...
                                NumberOfCots="${dataMap.get('SEARCH_HOTEL.Room_numberOfCots1')}" >
                                <PaxIds>
                                    <PaxId>${dataMap.get('PaxName.PaxId4')}</PaxId> 
                                    <PaxId>${dataMap.get('PaxName.PaxId5')}</PaxId> 
                                </PaxIds>
                            </HotelRoom>
                        </HotelRooms>
                    </HotelItem>
    ...
    public def BookingItemPriceBreakdownAsync(String sheetName,int rowNum, def bookingId, def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
   ...
   <RequestDetails>
    ...
    public def SearchBookingItemAsync(String sheetName,int rowNum, def bookingId , def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap && dataMap.get("Flag")){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
   ...
   <RequestDetails>
    ...
    public def ChargeConditionBookingAsync(String sheetName,int rowNum, def bookingId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap && dataMap.get("Flag")){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
    ...
    public def ModifyBookingRequestAsync(String sheetName,int rowNum, def bookingId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap ){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
 ...
 <RequestDetails>
    ...
    public def ModifyBookingItemRequestAsync(String sheetName,int rowNum, def bookingId, def roomId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        dataMap.put('HotelRoomId', roomId)
        if(dataMap){
            //return file
...
<Request>
 ...
 <ModifyBookingItemRequest>
    ...
    public def CancelBookingItemRequestAsync(String sheetName,int rowNum, def bookingId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap && dataMap.get("Flag")){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
   <Source>
    ...
    public def CancelBookingRequestAsync(String sheetName,int rowNum, def bookingId,def xmlName) {
        dataMap=getSheetDataAsMap(sheetName,rowNum)
        if(dataMap && dataMap.get("Flag")){
            //return file
            return	"""<?xml version="1.0" encoding="UTF-8"?>
