...
abstract class SearchChargeConditionsTest extends XSellBaseTest{
...
class SearchChargeConditionsTest_C1237 extends SearchChargeConditionsTest {
	@Override
	String getClientId() {
		return "1237"
	}
...
class SearchChargeConditionsTest_C1238 extends SearchChargeConditionsTest {
	@Override
	String getClientId() {
		return "1238"
	}
...
class SearchChargeConditionsTest_C1239 extends SearchChargeConditionsTest {
	@Override
	String getClientId() {
		return "1239"
	}
...
class SearchChargeConditionsTest_C1244 extends SearchChargeConditionsTest {
	@Override
	String getClientId() {
		return "1244"
	}
...
class SearchChargeConditionsTestSingleClient extends SearchChargeConditionsTest {
