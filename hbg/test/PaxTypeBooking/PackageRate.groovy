...
abstract class PackageRate extends XSellBaseTest{
	...
	static final String SHEET_NAME_SEARCH="PackageRate"
	...
	def "1. Verify Avilabel HBG Hotel #1 || #testDesc"(){
		...
		1		|"serach for avilable HBG hotel with package rate True " 		| 1
	}
	...
	def "Verify Search for avilable GTA hotel #2 || #testDesc"(){
		...
		String responseBody_search
			...
			for (k in 0..cities_GTA.size() - 1) {
				def fileContents_Search = helper.getPaxSearchWithPkgRatesXml(SHEET_NAME_SEARCH, searchRowNum, cities_GTA[k])
	...
	def "Verify Adding single item to booking test #5|| #testDesc"(){
		...
		if(successHotelDTO != null ) {
			...
			for(k in 0.. cities.size()-1 ){
				def fileContents_Search = helper.getPaxSearchWithPkgRatesXml(SHEET_NAME_SEARCH,searchRowNum,cities[k])
				println "Search Request for SearchChargeConditions.. \n${fileContents_Search}"
				def node_search = RequestNewHelper.postHttpsXMLRequestWithHeaderNode(url,'application/xml',fileContents_Search,'search',FITSiteIdHeaderKey,SITEID)
...
class PackageRate_C1237 extends PackageRate {
	@Override
	String getClientId() {
		return "1237"
	}
...
class PackageRate_C1238 extends PackageRate {
	@Override
	String getClientId() {
		return "1238"
	}
...
class PackageRate_C1239 extends PackageRate {
	@Override
	String getClientId() {
		return "1239"
	}
...
class PackageRate_C1244 extends PackageRate {
	@Override
	String getClientId() {
		return "1244"
	}
...
class PackageRateSingleClient extends PackageRate {
