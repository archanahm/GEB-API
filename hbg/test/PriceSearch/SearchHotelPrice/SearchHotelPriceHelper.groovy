...
//        httpClient
	...
	static boolean getPaxChargeConditionDetailsHBG(Node node_search, String itemCode, boolean isDateFormatResponseAvailable, String responseDateOrDay)
	{
		def flag=false
	...
	public String getCheckInDate(){
		...
		cal.add(Calendar.DAY_OF_MONTH, checkInDaysToAdd.toInteger())
			   ...
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            ...
			            <Rooms>
			                <Room Code = "SB" NumberOfCots = "0" NumberOfRooms = "1">
								<ExtraBeds/>
							</Room>
			            </Rooms>
			        </SearchHotelPriceRequest>
	...
	public def getCitySearchWithChildXml(String sheetName,int rowNum,def city, int noOfCots) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            ...
			            <Rooms>
			                <Room Code = "TB" NumberOfCots = "${noOfCots}" NumberOfRooms = "1">
								<ExtraBeds><Age>8</Age></ExtraBeds>
							</Room>
			            </Rooms>
			        </SearchHotelPriceRequest>
			    </RequestDetails>
	...
	public def getAreaSearchXml(String sheetName,int rowNum,def area, def cId) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            <ItemDestination DestinationCode = "${area}" DestinationType ="area"/>
						<ItemCode></ItemCode>
			            <PeriodOfStay>
			                <CheckInDate>${getCheckInDate()}</CheckInDate>
	...
	public def getGeocodeSearchXml(String sheetName,int rowNum) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            <ItemDestination DestinationType ="geocode" Latitude ="+035.336305000000000" 
							Longitude ="+025.123634000000000" RadiusKm ="0"/>
			            <PeriodOfStay>
			                <CheckInDate>${getCheckInDate()}</CheckInDate>
						    <Duration>${dataMap.get('SEARCH_HOTEL.Duration')}</Duration>
			            </PeriodOfStay>
	...
	public def getEssentialInformationXml(String sheetName,int rowNum) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            <ItemDestination DestinationCode = "par" DestinationType ="city"/>
	...
	public def getIncludePriceBreakDownXml(String sheetName,int rowNum,def city, def itemCode) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		dataMap.put('SEARCH_HOTEL.Destination_code', city)
		dataMap.put('SEARCH_HOTEL.ItemCode', itemCode)
		def requestXml = """<?xml version="1.0" encoding="UTF-8"?>
	...
	public def getSearchRequestWithIdXml(String sheetName,int rowNum,def city) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            ...
			            <Rooms>
			                <Room Code = "DB" NumberOfCots = "0" NumberOfRooms = "1" Id="">
								<ExtraBeds></ExtraBeds>
							</Room>
			            </Rooms>
			        </SearchHotelPriceRequest>
	...
	public def getMealBasisRequestXml(String sheetName,int rowNum,def city, def mealBasisCode) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
						...
						<MealBasisCodes><MealBasis>${mealBasisCode}</MealBasis></MealBasisCodes>
			            <Rooms>
			                <Room Code = "SB" NumberOfCots = "0" NumberOfRooms = "1">
								<ExtraBeds></ExtraBeds>
							</Room>
	...
	public def getStarRatingRequestXml(String sheetName,int rowNum,def city) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	public def getLocationCodeRequestXml(String sheetName,int rowNum,def city, def locCode) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
						...
						<LocationCode>${locCode}</LocationCode>
			        </SearchHotelPriceRequest>
			    </RequestDetails>
			</Request>"""
	}
	...
	public def getSearchXml(String sheetName,int rowNum,def city, String roomCode, String noOfCots, String noOfRooms) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
			            ...
			            <Rooms>
			                <Room Code = "${roomCode}" NumberOfCots = "${noOfCots}" NumberOfRooms = "${noOfRooms}">
								<ExtraBeds/>
							</Room>
			            </Rooms>
			        </SearchHotelPriceRequest>
	...
	public def getCitySearchXmlWithDateChargeCondition(String sheetName,int rowNum,def city, def itemCode, String dateChargeCondition) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		def requestXml = """<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
			    ...
			    <RequestDetails>
			        <SearchHotelPriceRequest>
						...
						<IncludeChargeConditions DateFormatResponse="${dateChargeCondition}"/>
						<Rooms>
			                <Room Code = "SB" NumberOfCots = "0" NumberOfRooms = "1">
								<ExtraBeds></ExtraBeds>
							</Room>
	...
	public def getCitySearchXmlWithEmptyChargeCondition(String sheetName,int rowNum,def city, def itemCode) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		def requestXml = """<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	public def getDateChargeConditionSearchXml(String sheetName,int rowNum,def city, String roomCode, String noOfCots, String noOfRooms, String dateChargeCondition) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	public def getDateChargeConditionEmptySearchXml(String sheetName,int rowNum,def city, String roomCode, String noOfCots, String noOfRooms) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	def boolean checkChargeConditionType(def hotels, boolean isDateType){
		if(hotels != null && hotels.size() > 0){
			for(i in 0.. hotels.size()-1){
				def rCategory = hotels[i].RoomCategories.RoomCategory
				for (int j=0;j<rCategory.size();j++){
					if(!(rCategory[j].@Id.toString().contains("ID_B2B")) && rCategory[j].@Id.toString().startsWith("007") && rCategory[j].Confirmation.@Code.contains("IM")){
						def chargeConditions = rCategory[j].ChargeConditions.ChargeCondition
						for (int k=0;k<chargeConditions.size();k++){
							def conditions = chargeConditions[k].Condition
							for (int l=0;l<conditions.size();l++){
								if (isDateType && conditions[l].@FromDate == null){
									return false
								}else if (!isDateType && conditions[l].@FromDay == null){
									return false
								}
							}
						}
	...
	public def getSearchXmlWith1ExtraBed(String sheetName,int rowNum,def city, String roomCode, String noOfCots, String noOfRooms) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	public def getIncludePriceBreakDownXmlWithExtraBed(String sheetName,int rowNum,def city, def itemCode) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		dataMap.put('SEARCH_HOTEL.Destination_code', city)
		dataMap.put('SEARCH_HOTEL.ItemCode', itemCode)
		def requestXml = """<?xml version="1.0" encoding="UTF-8"?>
	...
	public def getSearchXmlWithPackageRates(String sheetName,int rowNum,def city, String roomCode, String noOfCots, String noOfRooms) {
		dataMap=getSheetDataAsMap(sheetName,rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
			<Request>
			   <Source>
	...
	public def getSHPR_MultiRooms_CTY(String sheetName, int rowNum, def city, Map inputData) {
		dataMap = getSheetDataAsMap(sheetName, rowNum)
		return	"""<?xml version="1.0" encoding="UTF-8"?>
<Request>
    <Source>
	...
	def boolean verifyResponseContainsPackageRates(def hotels)
	{
		boolean result = true
		if(hotels != null && hotels.size() > 0){
			for(i in 0.. hotels.size()-1){
				...
				for (j in 0..rCategory.size()-1){
					if(!(rCategory[j].@Id.toString().contains("ID_B2B")) && rCategory[j].@Id.toString().startsWith("007") && rCategory[j].Confirmation.@Code.contains("IM")){
						//if (rCategory[j].ItemPrice.@PackageRate != null && rCategory[j].ItemPrice.@PackageRate.toString() == "true"){
						if (rCategory[j].ItemPrice.@PackageRate != null){
							continue
						}else{
							result = false
							break
	...
	def HotelDTO checkIfReponseHasMultipleRooms(def hotels)
	{
		HotelDTO hDTO = null
		if(hotels != null && hotels.size() > 0){
			for(i in 0.. hotels.size()-1){
